...
parser.add_argument('--data_url', default='./dataset', help='Directory contains CUB_200_2011 dataset.')
parser.add_argument('--train_url', default='./cache', help='Directory contains checkpoint file and eval.log')
parser.add_argument('--ckpt_filename', default='./cache/ckpt_0/cpcnnnet_best.ckpt', help='checkpoint file name')
...
if __name__ == '__main__':
    ...
    param_dict = load_checkpoint(args.ckpt_filename)
    ...
    for index, data in enumerate(test_data_loader):
        ...
        _, _, _, _, _, _, _, _, logits9_gate= ntsnet(image_data)
        result_label, _ = ops.ArgMaxWithValue(1)(logits9_gate)
